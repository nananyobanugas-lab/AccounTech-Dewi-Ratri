  ...
  return (
    <header className="h-20 bg-white items-center shadow-sm flex justify-between px-6 border-b">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="bg-primary-600 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-primary-700 transition-colors duration-300 flex items-center shadow-sm">
